...
| Marks | `Deep Thought: use Howard Marks's second-level thinking to examine an investment thesis that everyone already agrees with. The shares are $40 and the buyers say the company is great.` | Uses the second-level thinking page: consensus versus a differing expectation, and how the stated $40 price reflects that consensus. Does not substitute the second-order consequence chain. Does not invent earnings or a target price. |
